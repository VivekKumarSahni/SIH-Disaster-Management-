...
function Landing2() {
  ...
  function handleMessage(e) {
    ...
    if ("alert" in messageData){
      ...
      toast.error(`Alert, Please rush to the emergency location ${messageData.alert}`, {
        position: "top-right",
        autoClose: 5000,
...
>
  ...
  >
    3
      ...
      <Dropdown.Menu>
        <Dropdown.Item href="">1. Bhangagarh, Dispur, Kamrup Metropolitan District, Assam, 781005, India</Dropdown.Item>
        <Dropdown.Item href="">2. NH27, Guwahati, Kamrup Metropolitan District, Assam, 781015, India</Dropdown.Item>
        <Dropdown.Item href="">3. H-6 Nit Silchar , Silchar - 788010, Assam, India</Dropdown.Item>
      </Dropdown.Menu>
    </Dropdown>
